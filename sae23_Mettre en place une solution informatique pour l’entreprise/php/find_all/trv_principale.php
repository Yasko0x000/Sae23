<!--------------------------------------------------------------------------->
<!-- Code Permettant de trouver les données étudiantde la ville principale -->
<!--------------------------------------------------------------------------->
<?php
...
/*
  ...
  etudiant et la colonne nville de la table Villes elle sont pareil ET QUAND le prénom correspant à ce qui va étre ecrit sur la barre de  
*/

$stmt = $pdo->prepare("SELECT  prenom, nome, groupe, ville, nville, longitude, latitude FROM etudiant, Villes WHERE etudiant.ville = Villes.nville AND prenom LIKE ?");
