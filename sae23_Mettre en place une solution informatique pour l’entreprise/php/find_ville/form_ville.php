...
<body>                                    <!-- A partir de cette variable jusqu'a sa fermeture, il y'aura tout le contenu du site-->
  ...
  <header>      <!--En tete-->
        <h1> Trouver les données des villes souhaitées  <br> <span class="redfamily">(Tappez la ville, longitude ou latitude)</span></h1>
    </header>
...
<div class="search-wrapper">     <!-- Dans ce div nous allon crée la barre de recherche -->
	<form method="post" action="form_ville.php">    <!-- Avec la methode POST le formulaire va chercher les fonction dans le fichier form_ville.php -->
    ...
    if (isset($_POST["search"])) {
      ...
      if (count($results) > 0) { foreach ($results as $r) {
        ...
        printf ("<tbody>");
          printf ("<tr>");
              printf ("<td><strong>%s</strong></td>", $r["departement"]);
              printf ("<td><strong>%s</strong></td>" , $r["nville"]);
