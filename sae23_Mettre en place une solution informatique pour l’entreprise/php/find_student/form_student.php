...
<body>                                    <!-- A partir de cette variable jusqu'a sa fermeture, il y'aura tout le contenu du site-->
  ...
  <header>      <!--En tete-->
        <h1> Trouver les données d'un étudiant  <br> <span class="redfamily">(Nom, prenom, groupe, ville)</span></h1>
    </header>
...
<div class="search-wrapper">      <!-- Dans ce div nous allon crée la barre de recherche -->
	<form method="post" action="form_student.php">        <!-- Avec la methode POST le formulaire va chercher les fonction dans le fichier form_student.php -->
