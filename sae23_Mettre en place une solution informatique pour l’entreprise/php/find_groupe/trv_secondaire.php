<!----------------------------------------------------------------------->
<!-- Code Permettant de trouver les données groupe la ville secondaire -->
<!----------------------------------------------------------------------->
<?php
...
/*
  Nous allon executer la requete qui dit "Selectionner la COLONNE prenom, nome, groupe, ville, villeS, nville, longitude, latitude de la TABLE etudiant et Villes QUAND la colonne ville de la table 
...
*/
$stmt = $pdo->prepare("SELECT  prenom, nome, groupe, ville, villeS, nville, longitude, latitude FROM etudiant, Villes WHERE etudiant.villeS = Villes.nville AND groupe LIKE ?");
